...
def setup_routes(app):
    ...
    app.router.add_delete(
        '/api/order', views.delete_orders, name='delete_order')
    ...
    app.router.add_get('/api/ws_order_book',
                       views.ws_order_book, name='ws_order_book')
    app.router.add_get('/api/ws_trade_log',
                       views.ws_trade_log, name='ws_trade_log')
